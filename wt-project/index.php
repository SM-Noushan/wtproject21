...
<div class="container">
    <div class="row">
                            ...
                            <tr style="background-color: dimgray;">
                                <td>
                                    <div class="d-grid gap-2" style="height: 35px;">
                                        <form action="user/searchbook.php" method="post">
        ...
        <div class="col-sm-9">
            ...
            <div class="tag"><h2>Recently Added</h2></div>
            <div class="row" style="padding-bottom: 50px;">
                <?php
                    $sql = "SELECT * FROM bookdetails ORDER BY id DESC LIMIT 3";
                    $result = mysqli_query($conn, $sql);
                    if(mysqli_num_rows($result)>0){
                        while($row = mysqli_fetch_assoc($result)){
            ...
            <div class="tag"><h2>Random Books</h2></div>
            <div class="row" style="padding-bottom: 50px;">
                <?php
                    $output="";
                    $sql = "SELECT * FROM bookdetails ORDER BY RAND() DESC LIMIT 3";
                    $result = mysqli_query($conn, $sql);
                    if(mysqli_num_rows($result)>0){
                        while($row = mysqli_fetch_assoc($result)){
                            $img = str_replace("../","/wt-project/", $row['image']);   
